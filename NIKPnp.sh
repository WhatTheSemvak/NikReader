...
echo "==============================="
sleep 2
echo " Pembaca Nik Penipuan"
sleep 0.7
echo "==============================="
echo " Tools Pencegah Penipuan Online "
echo ""
echo Selamat datang $nick ":)"
echo "Tunggu Sebentar Sedang Menyambung Ke Server.." | lolcat
...
echo
echo "==================================="
echo " Tools ini Free Coeg-_"
echo " Nanti Di Ser lagi :v"
echo " Dilarang menjual belikan tools ini"
echo " Recode?? Besok Kencing Nanah:v"
echo "==================================="
